...
export const KEYS: Hex[] = [
  ...
  "0x92db14e403b83dfe3df233f83dfa3a0d7096f21ca9b0d6d6b8d88b2b4ec1564e", // punkbot's server — the agent's operating key, distinct from Alice's deed-holding wallet
];
